...
function parseDriverInfo(xml) {
    const result = {
        teamName: '', kartNumber: '', club: '', color: '',
        drivers: [], currentDriver: null,
    };
...
router.post('/team-details', async (req, res) => {
    try {
        ...
        let driverInfo = { teamName: '', kartNumber: '', club: '', color: '', drivers: [], currentDriver: null };
